...
const BannerItem = ({ slide }) => {
    ...
    const { images, id, prev, next } = slide;
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full" >
            <div className='carousel-img'>
                <img src={images} alt='' className="w-full rounded-xl" />
            </div>
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 w-2/4 left-24  top-1/2  m-5">
